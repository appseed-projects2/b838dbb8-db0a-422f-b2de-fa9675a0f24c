...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-23 07:30`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b838dbb8-db0a-422f-b2de-fa9675a0f24c.git
$ cd b838dbb8-db0a-422f-b2de-fa9675a0f24c
```
